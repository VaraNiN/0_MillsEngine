...
void playGame(bool isPlayerWhite, float maxComputationTime = 5., int maxCallDepth = 100, bool multiThreading = false, BoardState state = BoardState(), History history = History());
